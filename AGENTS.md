...
- Initial setup lists sites by connecting with `site=""`, then stores the selected site's short `name`; runtime may resolve legacy stored site IDs back to short names before controller use.

...
UniFi Presence is a Home Assistant custom integration for presence detection by looking at client devices connected to a Ubiquiti UniFi Network controller.
